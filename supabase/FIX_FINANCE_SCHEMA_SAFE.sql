-- Safe Fix for Finance Module Schema
-- This script handles existing policies and creates missing tables safely
...
-- ============================================================================
-- 8. SAFELY ENABLE RLS AND CREATE POLICIES
-- ============================================================================
...
DROP POLICY IF EXISTS "Finance data is viewable by authenticated users" ON transactions;
DROP POLICY IF EXISTS "Finance data is viewable by authenticated users" ON categories;
...
DROP POLICY IF EXISTS "Finance data is editable by admins" ON transactions;
DROP POLICY IF EXISTS "Finance data is editable by admins" ON categories;
