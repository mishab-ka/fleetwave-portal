...
-- This file contains all the necessary tables for the HR management system
...
-- HR Managers and Admins can see all data
CREATE POLICY "HR Managers and Admins can view all HR data" ON hr_managers
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM users u 
      JOIN user_roles ur ON u.role_id = ur.id 
      WHERE u.id = auth.uid() 
      AND (ur.role_name = 'admin' OR ur.role_name = 'super_admin')
    ) OR 
    EXISTS (
...
CREATE POLICY "HR Managers and Admins can view all HR staff" ON hr_staff
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM users u 
      JOIN user_roles ur ON u.role_id = ur.id 
...
CREATE POLICY "HR Managers and Admins can view all staff assignments" ON hr_staff_assignments
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM users u 
      JOIN user_roles ur ON u.role_id = ur.id 
...
CREATE POLICY "HR Managers and Admins can view all WhatsApp numbers" ON hr_whatsapp_numbers
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM users u 
      JOIN user_roles ur ON u.role_id = ur.id 
...
CREATE POLICY "HR Managers and Admins can view all lead statuses" ON hr_lead_statuses
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM users u 
      JOIN user_roles ur ON u.role_id = ur.id 
...
CREATE POLICY "HR Managers and Admins can view all leads" ON hr_leads
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM users u 
      JOIN user_roles ur ON u.role_id = ur.id 
...
CREATE POLICY "HR Managers and Admins can view all lead activities" ON hr_lead_activities
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM users u 
      JOIN user_roles ur ON u.role_id = ur.id 
