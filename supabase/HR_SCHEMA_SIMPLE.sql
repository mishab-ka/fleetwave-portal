-- =====================================================
-- HR PERFORMANCE MONITORING - SIMPLE APPROACH
-- =====================================================
-- This uses a simpler approach without complex indexes
...
-- ============================================================================
-- STEP 2: Create tables with date columns (no complex indexes needed)
-- ============================================================================
...
-- ============================================================================
-- STEP 3: Create simple indexes (no expressions)
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_hr_attendance_date ON hr_staff_attendance(attendance_date DESC);
...
-- ============================================================================
-- STEP 7: Create trigger to auto-populate attendance_date
-- ============================================================================
...
BEGIN
  IF NEW.attendance_date IS NULL THEN
    NEW.attendance_date = NEW.clock_in_time::date;
  END IF;
  RETURN NEW;
END;
$$ LANGUAGE plpgsql;

DROP TRIGGER IF EXISTS set_attendance_date_trigger ON hr_staff_attendance;

CREATE TRIGGER set_attendance_date_trigger
BEFORE INSERT ON hr_staff_attendance
...
-- 🎉 DONE!
-- ============================================================================
-- Tables created with simple structure - no complex index expressions!
-- The attendance_date column is automatically populated from clock_in_time
-- ============================================================================
