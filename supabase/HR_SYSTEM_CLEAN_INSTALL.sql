-- HR System Clean Install - Fixes Infinite Recursion
-- Run this to completely reset the HR system with fixed policies
...
-- Create RLS Policies - FIXED VERSION (No Recursion)
