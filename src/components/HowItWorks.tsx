  ...
  const steps = [
    {
      ...
      title: "Sign Up",
      description:
        "Register as a driver and complete your profile in just a few steps.",
    },
    {
      number: "02",
      title: "Upload Documents",
      description:
        "Submit your license, ID, and vehicle documents for quick verification.",
    },
    {
      number: "03",
      title: "Get Approved",
      description:
        "Our team will review your details and activate your driver account.",
    },
    {
      number: "04",
      title: "Start Driving",
      description:
        "Accept trips, earn money, and track your progress with our app.",
    },
  ];
      ...
      <div className="container px-6 md:px-10 mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16 stagger-animation">
          ...
          <p className="text-gray-600 text-lg">
            Getting started with Tawaaq is quick and easy. Follow these simple
            steps to transform your fleet management.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="space-y-12 md:space-y-0">
            {steps.map((step, index) => (
              <div
                ...
                } relative md:grid md:grid-cols-2 items-center gap-8 ${
              ...
              >
                ...
                >
                  <div className="w-16 h-16 bg-fleet-purple/10 rounded-full flex items-center justify-center mx-auto">
                    <span className="text-fleet-purple font-bold text-xl">
                      {step.number}
                    </span>
                  </div>
                </div>
          ...
          <div className="text-center mt-12 reveal reveal-bottom">
            <div className="inline-flex items-center gap-2 text-fleet-purple font-medium">
              <span>Start optimizing and earn</span>
