...
const statusConfig = {
  paid: { icon: Check, bg: 'bg-green-100 text-green-700 border-green-200', text: 'Paid' },
  overdue: { icon: AlertTriangle, bg: 'bg-red-100 text-red-700 border-red-200', text: 'Overdue' },
  pending: { icon: Clock, bg: 'bg-yellow-100 text-yellow-700 border-yellow-200', text: 'Pending' },
